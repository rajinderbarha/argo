      ...
      <div className="container-px">
        ...
        <div className="mt-8 grid gap-12 lg:grid-cols-2">
          ...
          <div>
              ...
              <div className="mt-6">
                ...
                <div className="flex gap-2">
                  {product.colors.map((c) => (
                    <span
                      key={c}
                      className="rounded-full border border-charcoal/15 px-3 py-1 text-xs font-medium text-charcoal/70"
                    >
                      {c}
                    </span>
                  ))}
            ...
            <div className="mt-8 grid grid-cols-1 gap-3 rounded-xl border border-charcoal/10 bg-mist/40 p-5 sm:grid-cols-2">
          ...
          <div>
            ...
            <ul className="mt-5 flex flex-col gap-3">
              {product.useCases.map((u) => (
                <li key={u} className="flex items-start gap-3 text-sm text-charcoal/70">
                  <CheckCircle2 className="mt-0.5 h-4 w-4 shrink-0 text-forest" />
                  {u}
                </li>
              ))}
        ...
        <div id="inquire" className="mt-20 rounded-2xl border border-charcoal/10 bg-mist/30 p-8 lg:p-12">
