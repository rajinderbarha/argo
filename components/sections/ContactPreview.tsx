  ...
  return (
    <section className="py-24">
      <div className="container-px">
        <Reveal
          variants={scaleIn}
          className="grid grid-cols-1 gap-6 rounded-2xl border border-charcoal/10 bg-white p-8 sm:grid-cols-3 lg:p-12"
        >
          <div>
            ...
            <Link
              href="/contact"
              className="group mt-5 inline-flex items-center gap-1.5 text-sm font-semibold text-forest hover:text-forest-600"
            >
              Visit contact page
