...
export function BlogCard({ post }: { post: BlogPost }) {
  return (
    <Link
      href={`/blog/${post.slug}`}
      className="card-glow group flex flex-col overflow-hidden rounded-xl border border-charcoal/10 bg-white transition-[transform,box-shadow] duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-1.5 hover:shadow-[0_24px_48px_-24px_rgba(17,24,39,0.25)]"
    >
